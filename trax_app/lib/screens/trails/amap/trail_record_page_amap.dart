...
class TrailRecordPageAmap extends StatefulWidget {
  const TrailRecordPageAmap({super.key});
...
class _TrailRecordPageAmapState extends State<TrailRecordPageAmap> {
  ...
  // Mirrors the Google variant: 1 s base, drop to 100 ms when the rider is
  // inside `_kFastSampleRadiusM` of the start/end of the recording AND
  // closing in (so we capture the lap-line crossing precisely). Reverts
  // to 1 s as soon as the rider starts moving away again.
      ...
      child: Column(
        ...
        children: [
          Text(
            _isPickingLapPoints
                ? 'Pick Waypoints'
                : (_isMockMode ? 'Simulating Lap' : 'Record Trail'),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                label: const Text('Start Lap Recording',
                    style: TextStyle(
            ...
            SizedBox(
              ...
              height: 50,
              child: OutlinedButton.icon(
                onPressed: _enterLapPickMode,
                icon: const Icon(Icons.touch_app, size: 22),
                label: const Text('Pick Points → Auto-Run',
                    style: TextStyle(
                        fontSize: 16, fontWeight: FontWeight.w600)),
                style: OutlinedButton.styleFrom(
