...
class RideAnalysisPageAmap extends StatefulWidget {
  final List<Map<String, dynamic>> points;
  final String rideName;

  const RideAnalysisPageAmap({
    super.key,
  ...
  @override
  State<RideAnalysisPageAmap> createState() => _RideAnalysisPageAmapState();
}

class _RideAnalysisPageAmapState extends State<RideAnalysisPageAmap> {
              ...
              child: Stack(
                children: [
                  AMapWidget(
                    ...
                    markers: {
                      Marker(
                        position: AmapAdapter.toAmap(_samples.first.position),
                        icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueGreen),
                      ),
                      Marker(
                        position: AmapAdapter.toAmap(_samples.last.position),
